#-------------------------------------#
# main entry of starting model training
# majority of the codes were inspired by https://github.com/bubbliiiing/yolo3-pytorch
#-------------------------------------#
import datetime
import os
...
'''
Notice:
1. input image format could be either jpg or png. 
2. loss function output would be stored at loss_%Y_%m_%d_%H_%M_%S under logs folder
3. weight file per each epoch would be store at logs folder as well
...
if __name__ == "__main__":
    ...
    fp16            = False
    #---------------------------------------------------------------------#
    #   classes_path    指向config下的txt，与自己训练的数据集相关 
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = 'config/yolo_weights.pth'
    #model_path      = ''
    #------------------------------------------------------#
    ...
    train_annotation_path   = 'data/list_train.txt'
    val_annotation_path     = 'data/list_val.txt'
